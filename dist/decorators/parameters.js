 ...
 */
function ContextRequestProperty(name) {
    return new ParameterDecorator('ContextRequestProperty').withType(metadata_1.ParamType.context_request_property).withName(name)
        .decorateNamedParameterOrProperty();
}
exports.ContextRequestProperty = ContextRequestProperty;
/**
 * A decorator to be used on class properties or on service method arguments
 * to inform that the decorated property or argument should be bound to the
