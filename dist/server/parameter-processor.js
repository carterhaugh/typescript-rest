...
var ParameterProcessor = /** @class */ (function () {
    ...
    ParameterProcessor.prototype.initializeParameterMappers = function () {
        ...
        parameterMapper.set(metadata_1.ParamType.context_request_property, function (context, property) { return _this.convertType(context.request[property.name], property.propertyType); });
